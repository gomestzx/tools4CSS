        ...
        <div className="flex mt-4 gap-4 justify-start p-5 md:p-0 lg:justify-between md:justify-center items-center flex-wrap">
          {palleteGradient.map((gradient) => (
            ...
            >
              ...
              >
                <CopyButton
                  className="bg-transparent p-0 absolute right-0 top-0 px-2 py-1 m-2 w-auto rounded-lg cursor-pointer"
                  textToCopy={`linear-gradient(80deg, ${gradient.color1}, ${gradient.color2})`}
                  withIcon
                />
              </div>
