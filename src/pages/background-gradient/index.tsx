...
const BackgroundGradient = () => {
  ...
  const handleRgbChange = (color: any, setColor: any) => (e: any) => {
    ...
    const rgb = {
      ...color,
      [name]: Math.max(0, Math.min(255, Number(sanitizedValue))),
    };
      ...
      <div className="w-full lg:w-4/6 mx-auto">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-1 mx-4 mt-4 lg:mx-0">
          <div className="col-span-8">
            <div className="slg:mx-0 flex flex-col lg:flex-row  gap-1">
              ...
              >
                <button
                  className="text-gray-600 bg-white dark:bg-mainDark dark:text-slate-200 absolute right-0 top-0 m-4 flex justify-center items-center rounded-md"
        ...
        <ControlsContainer className=" justify-between mt-1">
          <div className=" flex">
            ...
            >
              {" "}
              <MdOutlineCircle style={{ marginBottom: 3 }} />{" "}
              <span>Radial</span>
            </button>
            {type === "linear" && (
              <div className="flex items-center justify-center gap-2 w-36 ml-6">
