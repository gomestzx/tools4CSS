            ...
            <div className='w-full lg:w-4/6 mx-auto'>
                ...
                <div className='border border-slate-300 rounded-md shadow-sm bg-white p-4 text-gray-700 mt-4 flex flex-wrap justify-center items-center gap-6 font-EuclidRegular mx-4 lg:mx-0'>
                    <div className='flex items-center justify-center gap-2'>
                        ...
                        <ColorInput preview={scrollbarStyle.thumbColor} value={scrollbarStyle.thumbColor} onChange={(e) => setScrollbarStyle({ ...scrollbarStyle, thumbColor: e.target.value })} />
                    </div>
                    <div className='flex items-center justify-center gap-2'>
                        <span>Track Color:</span>
                        <ColorInput preview={scrollbarStyle.trackColor} value={scrollbarStyle.trackColor} onChange={(e) => setScrollbarStyle({ ...scrollbarStyle, trackColor: e.target.value })} />
                    </div>
                    <div className='flex items-center justify-center gap-2'>
                        <span>Width:</span>
                        <Slider
                            ...
                            onChange={(e, value) => setScrollbarStyle({...scrollbarStyle, width: value as number})}
                    ...
                    <div className='flex items-center justify-center gap-2'>
                        ...
                        <Slider
                            ...
                            onChange={(e, value) => setScrollbarStyle({...scrollbarStyle, borderRadius: value as number})}
                            step={1}
                            min={0}
                            max={30}
                        />
                    ...
                    <div className='flex items-center justify-center gap-2'>
                        ...
                        <Slider
                            ...
                            onChange={(e, value) => setScrollbarStyle({...scrollbarStyle, borderWidth: value as number})}
                            step={1}
                            min={0}
                            max={20}
                        />
                    ...
                    <div className='flex items-center justify-center gap-2'>
                        ...
                        <ColorInput preview={scrollbarStyle.borderColor} value={scrollbarStyle.borderColor} onChange={(e) => setScrollbarStyle({ ...scrollbarStyle, borderColor: e.target.value })} />
                    </div>
                ...
                <div className='w-auto md:w-full bg-slate-600 mt-4 mx-4 lg:mx-0 custom-scrollbar' style={{ maxHeight: '200px', overflow: 'auto' }}>
...
.scrollbar::-webkit-scrollbar-thumb {
    ...
    border:${scrollbarStyle.borderWidth}px solid ${scrollbarStyle.borderColor};
                ...
                <div className='mx-4 lg:mx-0'>
                    <CopyButton textToCopy={`.scroll-bar::-webkit-scrollbar {
    width: ${scrollbarStyle.width}px;
  }
