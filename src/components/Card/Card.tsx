        ...
        <div className="w-full">
          ...
          >
            ...
            <div className=" w-full flex flex-col items-start justify-center">
              ...
              <h2
                className={` text-lg pr-4 font-GilroyMedium leading-6 font-bold ml-2 dark:text-white`}
              >
                {props.title}
              </h2>

              <p
                className={`mt-1 ml-1 text-slate-800 leading-4 text-sm font-medium font-GilroyMedium mb-2 cursor-pointer p-1 dark:text-white`}
              >
                {props.info}
              </p>
