      ...
      >
        {isFavorited ? (
          <div className="flex flex-row justify-center items-center gap-2 p-3 md:px-4 md:py-2">
            ...
            <span className="hidden md:block font-lexend text-slate-800 font-normal text-base dark:text-white">
              Favorited
            </span>
          </div>
        ) : (
          <div className="flex flex-row justify-center items-center gap-2 p-3 md:px-4 md:py-2 ">
            ...
            <span className="hidden md:block text-slate-800 font-lexend font-normal text-base dark:text-white">
              Add to favorites
            </span>
          </div>
        )}
