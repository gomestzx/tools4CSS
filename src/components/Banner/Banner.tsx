...
export default function Banner() {
  return (
    <>
      <div className="dark:bg-mainDark bg-gray-50 w-full mt-10 flex flex-col lg:flex-row justify-between items-center rounded-lg border border-slate-300 dark:border-slate-600 p-4">
