...
<footer class="bg-gray-800 text-gray-200 py-12">
  <div class="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
    ...
    <div>
      ...
      <ul class="space-y-2">
        <li><a href="/about" class="hover:underline text-blue-400">About Us</a></li>
        <li><a href="/help" class="hover:underline text-blue-400">Help Center</a></li>
        <li><a href="/terms" class="hover:underline text-blue-400">Terms of Service</a></li>
        <li><a href="/privacy" class="hover:underline text-blue-400">Privacy Policy</a></li>
      </ul>
    </div>
    ...
    <div>
      ...
      <p class="text-gray-400">Email: support@example.com</p>
      <p class="text-gray-400">Phone: (123) 456-7890</p>
      <p class="text-gray-400">Address: 123 Main Street, Anytown, USA</p>
    </div>
  ...
  <div class="container mx-auto px-6">
    <div class="flex flex-col md:flex-row justify-between items-center">
      ...
      <div class="mb-8 md:mb-0">
        <h2 class="text-3xl font-bold">YourCompany</h2>
      </div>
      ...
      <!-- Social Media Icons -->
      <div class="flex space-x-4">
        <a href="#" aria-label="LinkedIn" class="text-gray-600 hover:text-gray-800">
          <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
            <!-- LinkedIn Icon -->
        ...
        <a href="#" aria-label="GitHub" class="text-gray-600 hover:text-gray-800">
          <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
            <!-- GitHub Icon -->
